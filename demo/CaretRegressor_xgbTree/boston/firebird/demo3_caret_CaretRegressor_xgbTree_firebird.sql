...
FROM (SELECT 3 AS nid, 8.40346432 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 5.29650021 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 11.6297874 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 17.1540737 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
FROM (SELECT 3 AS nid, 9.42059135 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 6.45432901 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 4.66252089 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 2.81009173 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 

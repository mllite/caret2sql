...
FROM (SELECT 2 AS nid, 6.93879271 AS "Estimator" FROM rdb$database UNION ALL SELECT 3 AS nid, 2.8984952 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 5.14169693 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
FROM (SELECT 3 AS nid, 1.62524307 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 2.84553504 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 2.45521569 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 4.69463873 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 

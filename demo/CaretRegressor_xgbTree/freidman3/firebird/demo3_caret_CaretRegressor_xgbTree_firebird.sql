...
FROM (SELECT 1 AS nid, 0.132199347 AS "Estimator" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.367680311 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
FROM (SELECT 1 AS nid, 0.109454684 AS "Estimator" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.230710372 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 

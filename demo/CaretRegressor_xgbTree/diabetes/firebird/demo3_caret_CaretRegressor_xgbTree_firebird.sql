...
FROM (SELECT 3 AS nid, 40.3788452 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 59.8967705 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 64.3968735 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 87.2963867 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
FROM (SELECT 3 AS nid, 29.2727852 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 16.3086166 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 42.4102859 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 70.2773743 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 

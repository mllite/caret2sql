...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= 0.33536782955282585) THEN CASE WHEN ("ADS"."Feature_9" <= 0.03440605737600827) THEN CASE WHEN ("ADS"."Feature_7" <= 0.27551445291777293) THEN CASE WHEN ("ADS"."Feature_5" <= -1.2339094735988072) THEN 7 ELSE CASE WHEN ("ADS"."Feature_3" <= -1.0519874233349027) THEN 9 ELSE 10 END END ELSE 6 END ELSE 4 END ELSE 2 END AS node_id_2 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" <= -0.8562539181886606) THEN 1 ELSE CASE WHEN ("ADS"."Feature_5" <= -1.1672475869648844) THEN CASE WHEN ("ADS"."Feature_7" <= 0.3766060966189835) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_5" <= 2.3706862901882166) THEN CASE WHEN ("ADS"."Feature_3" <= 1.448072609174438) THEN 9 ELSE 10 END ELSE 8 END END END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.43705304435181774) THEN CASE WHEN ("ADS"."Feature_3" <= 1.448072609174438) THEN CASE WHEN ("ADS"."Feature_5" <= 2.642269723836713) THEN CASE WHEN ("ADS"."Feature_9" <= 0.07895097499469822) THEN CASE WHEN ("ADS"."Feature_2" <= 1.8351728619410537) THEN CASE WHEN ("ADS"."Feature_3" <= 1.0940060794679303) THEN 13 ELSE CASE WHEN ("ADS"."Feature_5" <= -1.018699243157412) THEN 15 ELSE 16 END END ELSE 10 END ELSE CASE WHEN ("ADS"."Feature_7" <= -0.19865102599644446) THEN 11 ELSE 12 END END ELSE 6 END ELSE 4 END ELSE 2 END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= -0.039503190935283816) THEN CASE WHEN ("ADS"."Feature_1" <= 1.8150607318194536) THEN CASE WHEN ("ADS"."Feature_2" <= 1.5964465357931172) THEN CASE WHEN ("ADS"."Feature_8" <= 1.0674099273627222) THEN 9 ELSE CASE WHEN ("ADS"."Feature_0" <= 0.8082491395932163) THEN 11 ELSE 12 END END ELSE 8 END ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_4" <= 1.3486061133968472) THEN 5 ELSE 6 END END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= -0.039503190935283816) THEN CASE WHEN ("ADS"."Feature_5" <= 2.103515361960515) THEN CASE WHEN ("ADS"."Feature_6" <= 1.6239226805740852) THEN CASE WHEN ("ADS"."Feature_5" <= -1.3034205030935275) THEN CASE WHEN ("ADS"."Feature_5" <= -1.6772578499293331) THEN 11 ELSE 12 END ELSE 10 END ELSE 8 END ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9320249244442655) THEN 5 ELSE 6 END END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 4 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.09466859381021098) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3706862901882166) THEN CASE WHEN ("ADS"."Feature_2" <= 1.5964465357931172) THEN CASE WHEN ("ADS"."Feature_5" <= -1.3034205030935275) THEN CASE WHEN ("ADS"."Feature_5" <= -1.5701116477472163) THEN 11 ELSE 12 END ELSE 8 END ELSE CASE WHEN ("ADS"."Feature_9" <= -0.39884931031048176) THEN 9 ELSE 10 END END ELSE 4 END ELSE 2 END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= -0.039503190935283816) THEN CASE WHEN ("ADS"."Feature_3" <= 1.6463998330344634) THEN CASE WHEN ("ADS"."Feature_5" <= -1.4731858481771687) THEN CASE WHEN ("ADS"."Feature_3" <= 0.8794820234366546) THEN 9 ELSE 10 END ELSE 8 END ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_5" <= 1.9921290833157523) THEN 5 ELSE 6 END END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 4 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.03440605737600827) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3678844616328005) THEN CASE WHEN ("ADS"."Feature_3" <= 1.6463998330344634) THEN CASE WHEN ("ADS"."Feature_3" <= 1.242140021442021) THEN 9 ELSE CASE WHEN ("ADS"."Feature_3" <= 1.293872811286184) THEN 11 ELSE 12 END END ELSE 8 END ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_4" <= 1.237054970044466) THEN 5 ELSE 6 END END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= -0.29480912843714746) THEN CASE WHEN ("ADS"."Feature_6" <= 1.6740868271435323) THEN CASE WHEN ("ADS"."Feature_5" <= 2.5616024705269047) THEN 7 ELSE 8 END ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034810289708) THEN CASE WHEN ("ADS"."Feature_8" <= -1.7764182906345383) THEN CASE WHEN ("ADS"."Feature_5" <= -0.220327236814342) THEN 11 ELSE 12 END ELSE 10 END ELSE 6 END END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 4 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.13965497273694175) THEN CASE WHEN ("ADS"."Feature_5" <= -1.0882456141118804) THEN CASE WHEN ("ADS"."Feature_0" <= 1.285729038389948) THEN 7 ELSE 8 END ELSE CASE WHEN ("ADS"."Feature_6" <= 2.3498353727676995) THEN 9 ELSE 10 END END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034810289708) THEN 5 ELSE 6 END END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.15286022330599033) THEN CASE WHEN ("ADS"."Feature_6" <= 1.721083164420432) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3678844616328005) THEN CASE WHEN ("ADS"."Feature_5" <= -1.4731858481771687) THEN CASE WHEN ("ADS"."Feature_3" <= 0.8794820234366546) THEN 11 ELSE 12 END ELSE 10 END ELSE 8 END ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_6" <= 2.032079155829251) THEN 5 ELSE 6 END END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 4 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.03440605737600827) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3706862901882166) THEN CASE WHEN ("ADS"."Feature_5" <= -1.4731858481771687) THEN CASE WHEN ("ADS"."Feature_9" <= -0.975241899913162) THEN 9 ELSE 10 END ELSE 8 END ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_4" <= 1.9849525390261695) THEN 5 ELSE 6 END END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 4 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= 0.33536782955282585) THEN CASE WHEN ("ADS"."Feature_9" <= 0.03440605737600827) THEN CASE WHEN ("ADS"."Feature_5" <= -1.0882456141118804) THEN 5 ELSE CASE WHEN ("ADS"."Feature_5" <= 2.103515361960515) THEN 9 ELSE 10 END END ELSE CASE WHEN ("ADS"."Feature_6" <= 2.032079155829251) THEN 7 ELSE 8 END END ELSE 2 END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= -0.039503190935283816) THEN CASE WHEN ("ADS"."Feature_6" <= 1.6239226805740852) THEN CASE WHEN ("ADS"."Feature_4" <= -2.006970081197816) THEN 7 ELSE CASE WHEN ("ADS"."Feature_3" <= 1.7716785617254405) THEN CASE WHEN ("ADS"."Feature_3" <= 1.242140021442021) THEN 13 ELSE CASE WHEN ("ADS"."Feature_5" <= -1.224418530240524) THEN 15 ELSE 16 END END ELSE 12 END END ELSE CASE WHEN ("ADS"."Feature_9" <= -0.41398003223637664) THEN 9 ELSE 10 END END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034810289708) THEN 5 ELSE 6 END END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.03440605737600827) THEN CASE WHEN ("ADS"."Feature_6" <= 1.721083164420432) THEN CASE WHEN ("ADS"."Feature_5" <= 2.538127437091894) THEN CASE WHEN ("ADS"."Feature_5" <= -1.967097087334689) THEN CASE WHEN ("ADS"."Feature_1" <= -0.6856291068042197) THEN 9 ELSE 10 END ELSE 8 END ELSE 6 END ELSE 4 END ELSE 2 END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= -0.29480912843714746) THEN CASE WHEN ("ADS"."Feature_6" <= 1.695167084396542) THEN CASE WHEN ("ADS"."Feature_5" <= 2.270956508864192) THEN CASE WHEN ("ADS"."Feature_3" <= 1.0940060794679303) THEN 9 ELSE CASE WHEN ("ADS"."Feature_5" <= -1.224418530240524) THEN 11 ELSE 12 END END ELSE 8 END ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.3399010523465291) THEN 5 ELSE 6 END END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 4 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 

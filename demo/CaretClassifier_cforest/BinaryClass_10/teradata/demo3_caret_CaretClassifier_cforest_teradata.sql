...
FROM (SELECT 1 AS nid, CAST(0.5 AS DOUBLE PRECISION) AS "P_0", CAST(0.5 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.5 AS DOUBLE PRECISION) AS "DP" 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= CAST(0.016378282006634 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_6" <= CAST(1.053279620737388 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_5" <= CAST(-1.205668922822983 AS DOUBLE PRECISION)) THEN 6 ELSE 7 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_1 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_1" AS 
...
FROM dummy_cte_1 UNION ALL SELECT 4 AS nid, CAST(0.571428571428571 AS DOUBLE PRECISION) AS "P_0", CAST(0.428571428571429 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.571428571428571 AS DOUBLE PRECISION) AS "DP" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= CAST(-0.274695083685867 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_5" <= CAST(1.444272190737573 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= CAST(-0.936205725547557 AS DOUBLE PRECISION)) THEN 6 ELSE 7 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_2 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_2" AS 
...
FROM dummy_cte_2 UNION ALL SELECT 4 AS nid, CAST(0.75 AS DOUBLE PRECISION) AS "P_0", CAST(0.25 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.75 AS DOUBLE PRECISION) AS "DP" 
...
FROM dummy_cte_2 UNION ALL SELECT 7 AS nid, CAST(0.230769230769231 AS DOUBLE PRECISION) AS "P_0", CAST(0.769230769230769 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(0.769230769230769 AS DOUBLE PRECISION) AS "DP" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" <= CAST(-0.060448736905913 AS DOUBLE PRECISION)) THEN 2 ELSE CASE WHEN ("ADS"."Feature_0" <= CAST(1.07137559315129 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_4" <= CAST(-0.152065143975703 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_5" <= CAST(-1.205668922822983 AS DOUBLE PRECISION)) THEN 6 ELSE 7 END ELSE 8 END ELSE 9 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_3 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, CAST(0.03030303030303 AS DOUBLE PRECISION) AS "P_0", CAST(0.96969696969697 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(0.96969696969697 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_3 UNION ALL SELECT 6 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_0", CAST(1.0 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(1.0 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_3 UNION ALL SELECT 7 AS nid, CAST(0.833333333333333 AS DOUBLE PRECISION) AS "P_0", CAST(0.166666666666667 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.833333333333333 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_3 UNION ALL SELECT 8 AS nid, CAST(0.846153846153846 AS DOUBLE PRECISION) AS "P_0", CAST(0.153846153846154 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.846153846153846 AS DOUBLE PRECISION) AS "DP" 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 1 AS nid, CAST(0.4375 AS DOUBLE PRECISION) AS "P_0", CAST(0.5625 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(0.5625 AS DOUBLE PRECISION) AS "DP" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= CAST(0.015023609022383 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_9" <= CAST(-1.049456845029877 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_7" <= CAST(-0.24311822647809 AS DOUBLE PRECISION)) THEN 6 ELSE 7 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_5 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, CAST(1.0 AS DOUBLE PRECISION) AS "P_0", CAST(0.0 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(1.0 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_5 UNION ALL SELECT 4 AS nid, CAST(0.642857142857143 AS DOUBLE PRECISION) AS "P_0", CAST(0.357142857142857 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.642857142857143 AS DOUBLE PRECISION) AS "DP" 
...
FROM dummy_cte_5 UNION ALL SELECT 7 AS nid, CAST(0.3 AS DOUBLE PRECISION) AS "P_0", CAST(0.7 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(0.7 AS DOUBLE PRECISION) AS "DP" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= CAST(0.016378282006634 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_6" <= CAST(0.452030376839699 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_8" <= CAST(-0.967578463348191 AS DOUBLE PRECISION)) THEN 6 ELSE CASE WHEN ("ADS"."Feature_6" <= CAST(0.266043191577071 AS DOUBLE PRECISION)) THEN 8 ELSE 9 END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_6 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_0", CAST(1.0 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(1.0 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_6 UNION ALL SELECT 4 AS nid, CAST(0.285714285714286 AS DOUBLE PRECISION) AS "P_0", CAST(0.714285714285714 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(0.714285714285714 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_6 UNION ALL SELECT 6 AS nid, CAST(0.428571428571429 AS DOUBLE PRECISION) AS "P_0", CAST(0.571428571428571 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(0.571428571428571 AS DOUBLE PRECISION) AS "DP" 
...
FROM dummy_cte_6 UNION ALL SELECT 9 AS nid, CAST(0.6 AS DOUBLE PRECISION) AS "P_0", CAST(0.4 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.6 AS DOUBLE PRECISION) AS "DP" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_6" <= CAST(1.053279620737388 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_9" <= CAST(-0.274695083685867 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE 5 END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_7 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, CAST(0.948717948717949 AS DOUBLE PRECISION) AS "P_0", CAST(0.051282051282051 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.948717948717949 AS DOUBLE PRECISION) AS "DP" 
...
FROM dummy_cte_7 UNION ALL SELECT 5 AS nid, CAST(0.923076923076923 AS DOUBLE PRECISION) AS "P_0", CAST(0.076923076923077 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.923076923076923 AS DOUBLE PRECISION) AS "DP" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= CAST(-0.274695083685867 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_2" <= CAST(-0.860807679380979 AS DOUBLE PRECISION)) THEN 3 ELSE CASE WHEN ("ADS"."Feature_3" <= CAST(1.227621399920398 AS DOUBLE PRECISION)) THEN 5 ELSE 6 END END ELSE 7 END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_8 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, CAST(0.5 AS DOUBLE PRECISION) AS "P_0", CAST(0.5 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.5 AS DOUBLE PRECISION) AS "DP" 
...
FROM dummy_cte_8 UNION ALL SELECT 6 AS nid, CAST(0.75 AS DOUBLE PRECISION) AS "P_0", CAST(0.25 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.75 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_8 UNION ALL SELECT 7 AS nid, CAST(0.029411764705882 AS DOUBLE PRECISION) AS "P_0", CAST(0.970588235294118 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(0.970588235294118 AS DOUBLE PRECISION) AS "DP" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= CAST(-0.041882346805845 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_9" <= CAST(0.428250773430976 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_9" <= CAST(-1.049456845029877 AS DOUBLE PRECISION)) THEN 6 ELSE 7 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_9 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_9" AS 
...
FROM dummy_cte_9 UNION ALL SELECT 7 AS nid, CAST(0.62962962962963 AS DOUBLE PRECISION) AS "P_0", CAST(0.37037037037037 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.62962962962963 AS DOUBLE PRECISION) AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_6" <= CAST(-1.286187674886164 AS DOUBLE PRECISION)) THEN 2 ELSE 3 END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_10 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_10" AS 
...
FROM dummy_cte_10 UNION ALL SELECT 3 AS nid, CAST(0.534246575342466 AS DOUBLE PRECISION) AS "P_0", CAST(0.465753424657534 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.534246575342466 AS DOUBLE PRECISION) AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= CAST(0.015023609022383 AS DOUBLE PRECISION)) THEN 2 ELSE 3 END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_11 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, CAST(0.78 AS DOUBLE PRECISION) AS "P_0", CAST(0.22 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.78 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_11 UNION ALL SELECT 3 AS nid, CAST(0.033333333333333 AS DOUBLE PRECISION) AS "P_0", CAST(0.966666666666667 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(0.966666666666667 AS DOUBLE PRECISION) AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_6" <= CAST(0.60988500487132 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_0" <= CAST(-0.479905124597652 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_3" <= CAST(0.811656783920192 AS DOUBLE PRECISION)) THEN 6 ELSE 7 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_12 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_0", CAST(1.0 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(1.0 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_12 UNION ALL SELECT 4 AS nid, CAST(0.5 AS DOUBLE PRECISION) AS "P_0", CAST(0.5 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.5 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_12 UNION ALL SELECT 6 AS nid, CAST(0.947368421052632 AS DOUBLE PRECISION) AS "P_0", CAST(0.052631578947368 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.947368421052632 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_12 UNION ALL SELECT 7 AS nid, CAST(0.4 AS DOUBLE PRECISION) AS "P_0", CAST(0.6 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(0.6 AS DOUBLE PRECISION) AS "DP" 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 1 AS nid, CAST(0.5625 AS DOUBLE PRECISION) AS "P_0", CAST(0.4375 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.5625 AS DOUBLE PRECISION) AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= CAST(0.015023609022383 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_9" <= CAST(-1.049456845029877 AS DOUBLE PRECISION)) THEN 3 ELSE CASE WHEN ("ADS"."Feature_1" <= CAST(0.015595585536106 AS DOUBLE PRECISION)) THEN 5 ELSE 6 END END ELSE 7 END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_14 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, CAST(1.0 AS DOUBLE PRECISION) AS "P_0", CAST(0.0 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(1.0 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_14 UNION ALL SELECT 5 AS nid, CAST(0.4 AS DOUBLE PRECISION) AS "P_0", CAST(0.6 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(0.6 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte_14 UNION ALL SELECT 6 AS nid, CAST(0.85 AS DOUBLE PRECISION) AS "P_0", CAST(0.15 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.85 AS DOUBLE PRECISION) AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" <= CAST(-0.734329708387604 AS DOUBLE PRECISION)) THEN 2 ELSE CASE WHEN ("ADS"."Feature_5" <= CAST(-0.999173288515931 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_7" <= CAST(0.332625375514954 AS DOUBLE PRECISION)) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_3" <= CAST(-0.502667491441903 AS DOUBLE PRECISION)) THEN 8 ELSE 9 END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_15 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_15" AS 
...
FROM dummy_cte_15 UNION ALL SELECT 8 AS nid, CAST(0.857142857142857 AS DOUBLE PRECISION) AS "P_0", CAST(0.142857142857143 AS DOUBLE PRECISION) AS "P_1", 0 AS "D", CAST(0.857142857142857 AS DOUBLE PRECISION) AS "DP" 

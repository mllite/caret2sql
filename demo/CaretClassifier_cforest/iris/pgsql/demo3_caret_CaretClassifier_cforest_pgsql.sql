...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.5 AS "P_1", 0.5 AS "P_2", 1 AS "D", 0.5 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_1" AS 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 1.9) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= 1.7) THEN CASE WHEN ("ADS"."Feature_3" <= 1.4) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_3" <= 1.9) THEN 8 ELSE 9 END END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.6 AS "P_1", 0.4 AS "P_2", 1 AS "D", 0.6 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 0.111111111111111 AS "P_1", 0.888888888888889 AS "P_2", 2 AS "D", 0.888888888888889 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_2" AS 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 1.9) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= 1.7) THEN CASE WHEN ("ADS"."Feature_2" <= 4.7) THEN CASE WHEN ("ADS"."Feature_3" <= 1.3) THEN 6 ELSE 7 END ELSE 8 END ELSE CASE WHEN ("ADS"."Feature_2" <= 5.1) THEN 10 ELSE 11 END END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 0.9285714285714286 AS "P_1", 0.07142857142857137 AS "P_2", 1 AS "D", 0.9285714285714286 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 0.5 AS "P_1", 0.5 AS "P_2", 1 AS "D", 0.5 AS "DP" UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 0.125 AS "P_1", 0.875 AS "P_2", 2 AS "D", 0.875 AS "DP" UNION ALL SELECT 11 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_3" AS 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 1.9) THEN 2 ELSE CASE WHEN ("ADS"."Feature_2" <= 5.0) THEN CASE WHEN ("ADS"."Feature_3" <= 1.6) THEN 5 ELSE 6 END ELSE 7 END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.222222222222222 AS "P_1", 0.777777777777778 AS "P_2", 2 AS "D", 0.777777777777778 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_4" AS 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 1.9) THEN 2 ELSE CASE WHEN ("ADS"."Feature_2" <= 4.8) THEN CASE WHEN ("ADS"."Feature_0" <= 5.1) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_3" <= 1.8) THEN 8 ELSE 9 END END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 0.875 AS "P_1", 0.125 AS "P_2", 1 AS "D", 0.875 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 0.230769230769231 AS "P_1", 0.769230769230769 AS "P_2", 2 AS "D", 0.769230769230769 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_5" AS 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 1.9) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= 1.7) THEN CASE WHEN ("ADS"."Feature_2" <= 4.5) THEN 5 ELSE 6 END ELSE 7 END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.666666666666667 AS "P_1", 0.333333333333333 AS "P_2", 1 AS "D", 0.666666666666667 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_6" AS 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" <= 0.6) THEN 2 ELSE CASE WHEN ("ADS"."Feature_2" <= 4.9) THEN CASE WHEN ("ADS"."Feature_3" <= 1.4) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_2" <= 5.1) THEN 8 ELSE 9 END END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.769230769230769 AS "P_1", 0.230769230769231 AS "P_2", 1 AS "D", 0.769230769230769 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 0.111111111111111 AS "P_1", 0.888888888888889 AS "P_2", 2 AS "D", 0.888888888888889 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_7" AS 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 1.9) THEN 2 ELSE CASE WHEN ("ADS"."Feature_2" <= 4.9) THEN CASE WHEN ("ADS"."Feature_3" <= 1.4) THEN 5 ELSE 6 END ELSE 7 END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.785714285714286 AS "P_1", 0.214285714285714 AS "P_2", 1 AS "D", 0.785714285714286 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_8" AS 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" <= 0.6) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= 1.6) THEN CASE WHEN ("ADS"."Feature_3" <= 1.3) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_3" <= 1.8) THEN 8 ELSE 9 END END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.842105263157895 AS "P_1", 0.157894736842105 AS "P_2", 1 AS "D", 0.842105263157895 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 0.230769230769231 AS "P_1", 0.769230769230769 AS "P_2", 2 AS "D", 0.769230769230769 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_9" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 1.9) THEN 2 ELSE CASE WHEN ("ADS"."Feature_2" <= 4.8) THEN CASE WHEN ("ADS"."Feature_3" <= 1.5) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_3" <= 1.8) THEN 8 ELSE 9 END END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.625 AS "P_1", 0.375 AS "P_2", 1 AS "D", 0.625 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 0.142857142857143 AS "P_1", 0.857142857142857 AS "P_2", 2 AS "D", 0.857142857142857 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_11" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 1.9) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= 1.6) THEN CASE WHEN ("ADS"."Feature_2" <= 4.7) THEN 5 ELSE 6 END ELSE 7 END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.375 AS "P_1", 0.625 AS "P_2", 2 AS "D", 0.625 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_12" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 1.9) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= 1.7) THEN CASE WHEN ("ADS"."Feature_2" <= 4.8) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_2" <= 5.1) THEN 8 ELSE 9 END END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.555555555555556 AS "P_1", 0.444444444444444 AS "P_2", 1 AS "D", 0.555555555555556 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 0.08333333333333329 AS "P_1", 0.9166666666666667 AS "P_2", 2 AS "D", 0.9166666666666667 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_13" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 1.9) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= 1.5) THEN CASE WHEN ("ADS"."Feature_2" <= 4.7) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_3" <= 1.8) THEN 8 ELSE 9 END END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.444444444444444 AS "P_1", 0.555555555555556 AS "P_2", 2 AS "D", 0.555555555555556 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 0.06666666666666672 AS "P_1", 0.9333333333333333 AS "P_2", 2 AS "D", 0.9333333333333333 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_14" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 1.9) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= 1.7) THEN CASE WHEN ("ADS"."Feature_2" <= 4.8) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_2" <= 4.9) THEN 8 ELSE 9 END END END AS node_id_2 
FROM iris AS "ADS"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.571428571428571 AS "P_1", 0.428571428571429 AS "P_2", 1 AS "D", 0.571428571428571 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 0.428571428571429 AS "P_1", 0.571428571428571 AS "P_2", 2 AS "D", 0.571428571428571 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_15" AS 
...
FROM (SELECT "RF_0"."KEY" AS "KEY", CAST("RF_0"."Score_0" AS FLOAT) AS "Score_0", CAST("RF_0"."Proba_0" AS FLOAT) AS "Proba_0", CAST("RF_0"."LogProba_0" AS FLOAT) AS "LogProba_0", CAST("RF_0"."Score_1" AS FLOAT) AS "Score_1", CAST("RF_0"."Proba_1" AS FLOAT) AS "Proba_1", CAST("RF_0"."LogProba_1" AS FLOAT) AS "LogProba_1", CAST("RF_0"."Score_2" AS FLOAT) AS "Score_2", CAST("RF_0"."Proba_2" AS FLOAT) AS "Proba_2", CAST("RF_0"."LogProba_2" AS FLOAT) AS "LogProba_2" 
FROM "RF_0" UNION ALL SELECT "RF_1"."KEY" AS "KEY", CAST("RF_1"."Score_0" AS FLOAT) AS "Score_0", CAST("RF_1"."Proba_0" AS FLOAT) AS "Proba_0", CAST("RF_1"."LogProba_0" AS FLOAT) AS "LogProba_0", CAST("RF_1"."Score_1" AS FLOAT) AS "Score_1", CAST("RF_1"."Proba_1" AS FLOAT) AS "Proba_1", CAST("RF_1"."LogProba_1" AS FLOAT) AS "LogProba_1", CAST("RF_1"."Score_2" AS FLOAT) AS "Score_2", CAST("RF_1"."Proba_2" AS FLOAT) AS "Proba_2", CAST("RF_1"."LogProba_2" AS FLOAT) AS "LogProba_2" 
FROM "RF_1") AS "RFbig_esu"), 
"RF_avg" AS 
(SELECT "T"."KEY" AS "KEY", CAST("T"."Score_0" AS FLOAT) AS "Score_0", CAST("T"."Proba_0" AS FLOAT) AS "Proba_0", CAST("T"."LogProba_0" AS FLOAT) AS "LogProba_0", CAST("T"."Score_1" AS FLOAT) AS "Score_1", CAST("T"."Proba_1" AS FLOAT) AS "Proba_1", CAST("T"."LogProba_1" AS FLOAT) AS "LogProba_1", CAST("T"."Score_2" AS FLOAT) AS "Score_2", CAST("T"."Proba_2" AS FLOAT) AS "Proba_2", CAST("T"."LogProba_2" AS FLOAT) AS "LogProba_2" 
FROM (SELECT "RF"."KEY" AS "KEY", avg(CAST("RF"."Score_0" AS FLOAT)) AS "Score_0", avg(CAST("RF"."Proba_0" AS FLOAT)) AS "Proba_0", CAST(NULL AS FLOAT) AS "LogProba_0", avg(CAST("RF"."Score_1" AS FLOAT)) AS "Score_1", avg(CAST("RF"."Proba_1" AS FLOAT)) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_1", avg(CAST("RF"."Score_2" AS FLOAT)) AS "Score_2", avg(CAST("RF"."Proba_2" AS FLOAT)) AS "Proba_2", CAST(NULL AS FLOAT) AS "LogProba_2" 

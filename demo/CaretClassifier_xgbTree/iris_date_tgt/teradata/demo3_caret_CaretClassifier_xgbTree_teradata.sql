...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" < CAST(2.45000005 AS DOUBLE PRECISION)) THEN 1 ELSE 2 END AS node_id_2 
FROM iris_date_tgt AS "ADS"), 
dummy_cte AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(0.565605104 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 2 AS nid, CAST(-0.292082161 AS DOUBLE PRECISION) AS "Score" 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" < CAST(2.45000005 AS DOUBLE PRECISION)) THEN 1 ELSE CASE WHEN ("ADS"."Feature_2" < CAST(4.85000038 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END END AS node_id_2 
FROM iris_date_tgt AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(-0.282802582 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 3 AS nid, CAST(0.523636341 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 4 AS nid, CAST(-0.227027059 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_1" AS 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" < CAST(4.85000038 AS DOUBLE PRECISION)) THEN 1 ELSE 2 END AS node_id_2 
FROM iris_date_tgt AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(-0.268370628 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 2 AS nid, CAST(0.512432456 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_2" AS 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" < CAST(0.800000012 AS DOUBLE PRECISION)) THEN 1 ELSE 2 END AS node_id_2 
FROM iris_date_tgt AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(0.353281915 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 2 AS nid, CAST(-0.25220567 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_3" AS 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" < CAST(1.75 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_3" < CAST(0.800000012 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM iris_date_tgt AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, CAST(-0.233748123 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 3 AS nid, CAST(-0.241275072 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 4 AS nid, CAST(0.321771652 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_4" AS 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" < CAST(4.75 AS DOUBLE PRECISION)) THEN 1 ELSE CASE WHEN ("ADS"."Feature_2" < CAST(5.35000038 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END END AS node_id_2 
FROM iris_date_tgt AS "ADS"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(-0.237592503 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 3 AS nid, CAST(0.221523523 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 4 AS nid, CAST(0.356381148 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_5" AS 
...
FROM "XGB_Model_0_1" UNION ALL SELECT "XGB_Model_1_1"."KEY" AS "KEY", CAST("XGB_Model_1_1"."Score_1789-07-14T00:00:00.000000000" AS DOUBLE PRECISION) AS "Score_1789-07-14T00:00:00.000000000", CAST("XGB_Model_1_1"."Score_1789-08-14T00:00:00.000000000" AS DOUBLE PRECISION) AS "Score_1789-08-14T00:00:00.000000000", CAST("XGB_Model_1_1"."Score_1789-09-14T00:00:00.000000000" AS DOUBLE PRECISION) AS "Score_1789-09-14T00:00:00.000000000" 
...
FROM (SELECT "XGB_0"."KEY" AS "KEY", CAST("XGB_0"."Score_1789-07-14T00:00:00.000000000" AS DOUBLE PRECISION) AS "Score_1789-07-14T00:00:00.000000000", CAST("XGB_0"."Score_1789-08-14T00:00:00.000000000" AS DOUBLE PRECISION) AS "Score_1789-08-14T00:00:00.000000000", CAST("XGB_0"."Score_1789-09-14T00:00:00.000000000" AS DOUBLE PRECISION) AS "Score_1789-09-14T00:00:00.000000000" 
FROM "XGB_0") AS "XGBbig_esu"), 
"XGB_sum" AS 
(SELECT "T"."KEY" AS "KEY", CAST("T"."Score_1789-07-14T00:00:00.000000000" AS DOUBLE PRECISION) AS "Score_1789-07-14T00:00:00.000000000", CAST("T"."Score_1789-08-14T00:00:00.000000000" AS DOUBLE PRECISION) AS "Score_1789-08-14T00:00:00.000000000", CAST("T"."Score_1789-09-14T00:00:00.000000000" AS DOUBLE PRECISION) AS "Score_1789-09-14T00:00:00.000000000" 

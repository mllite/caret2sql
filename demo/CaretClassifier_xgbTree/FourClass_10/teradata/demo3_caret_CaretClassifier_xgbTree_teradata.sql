...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" < CAST(0.548929513 AS DOUBLE PRECISION)) THEN 1 ELSE 2 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
dummy_cte AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(0.1704918 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 2 AS nid, CAST(-0.202985078 AS DOUBLE PRECISION) AS "Score" 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" < CAST(1.17717016 AS DOUBLE PRECISION)) THEN 1 ELSE 2 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(-0.229370624 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 2 AS nid, CAST(0.290265501 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_1" AS 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" < CAST(-0.17566067 AS DOUBLE PRECISION)) THEN 1 ELSE 2 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(0.260674179 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 2 AS nid, CAST(-0.138922155 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_2" AS 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" < CAST(0.362348735 AS DOUBLE PRECISION)) THEN 1 ELSE 2 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(0.25 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 2 AS nid, CAST(-0.200000003 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_3" AS 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_4" < CAST(-0.354841292 AS DOUBLE PRECISION)) THEN 1 ELSE 2 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(-0.203319311 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 2 AS nid, CAST(0.22877045 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_4" AS 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" < CAST(0.722315252 AS DOUBLE PRECISION)) THEN 1 ELSE 2 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(-0.229255274 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 2 AS nid, CAST(0.163921282 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_5" AS 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" < CAST(0.213004261 AS DOUBLE PRECISION)) THEN 1 ELSE 2 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(0.158995256 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 2 AS nid, CAST(-0.210747153 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(0.184584901 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 2 AS nid, CAST(-0.181764036 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_7" AS 

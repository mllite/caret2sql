...
FROM (SELECT 1 AS nid, 0.1704918 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, -0.202985078 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, -0.229370624 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.290265501 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, 0.260674179 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, -0.138922155 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, 0.25 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, -0.200000003 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, -0.203319311 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.22877045 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, -0.229255274 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.163921282 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, 0.158995256 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, -0.210747153 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, 0.184584901 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, -0.181764036 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 

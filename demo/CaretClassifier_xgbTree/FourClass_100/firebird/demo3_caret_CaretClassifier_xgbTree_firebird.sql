...
FROM (SELECT 1 AS nid, -0.221848756 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.1704918 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, 0.179591835 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, -0.107462697 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, 0.169343069 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, -0.222950816 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, -0.0793893188 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.332584262 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
FROM (SELECT "XGB_Model_2_0"."KEY" AS "KEY", CAST("XGB_Model_2_0"."Score_0" AS DOUBLE PRECISION) AS "Score_0", CAST("XGB_Model_2_0"."Score_1" AS DOUBLE PRECISION) AS "Score_1", CAST("XGB_Model_2_0"."Score_2" AS DOUBLE PRECISION) AS "Score_2", CAST("XGB_Model_2_0"."Score_3" AS DOUBLE PRECISION) AS "Score_3" 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, -0.200451136 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.234810278 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, -0.182124004 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.149085179 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
FROM (SELECT "XGB_Model_0_1"."KEY" AS "KEY", CAST("XGB_Model_0_1"."Score_0" AS DOUBLE PRECISION) AS "Score_0", CAST("XGB_Model_0_1"."Score_1" AS DOUBLE PRECISION) AS "Score_1", CAST("XGB_Model_0_1"."Score_2" AS DOUBLE PRECISION) AS "Score_2", CAST("XGB_Model_0_1"."Score_3" AS DOUBLE PRECISION) AS "Score_3" 
...
FROM "XGB_Model_1_1") AS "XGB_esu_2"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_44" < -0.879374504) THEN 1 ELSE 2 END AS node_id_2 
FROM "FourClass_100" AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, 0.296248347 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, -0.130245715 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, -0.138867661 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.164351091 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
FROM (SELECT "XGB_Model_2_1"."KEY" AS "KEY", CAST("XGB_Model_2_1"."Score_0" AS DOUBLE PRECISION) AS "Score_0", CAST("XGB_Model_2_1"."Score_1" AS DOUBLE PRECISION) AS "Score_1", CAST("XGB_Model_2_1"."Score_2" AS DOUBLE PRECISION) AS "Score_2", CAST("XGB_Model_2_1"."Score_3" AS DOUBLE PRECISION) AS "Score_3" 
...
FROM "XGB_Model_3_1") AS "XGB_esu_3"), 
"XGB" AS 

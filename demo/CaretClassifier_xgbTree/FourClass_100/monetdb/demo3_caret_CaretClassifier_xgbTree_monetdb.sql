...
FROM (SELECT 1 AS nid, -0.221848756 AS "Score" UNION ALL SELECT 2 AS nid, 0.1704918 AS "Score") AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, 0.179591835 AS "Score" UNION ALL SELECT 2 AS nid, -0.107462697 AS "Score") AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, 0.169343069 AS "Score" UNION ALL SELECT 2 AS nid, -0.222950816 AS "Score") AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, -0.0793893188 AS "Score" UNION ALL SELECT 2 AS nid, 0.332584262 AS "Score") AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, -0.200451136 AS "Score" UNION ALL SELECT 2 AS nid, 0.234810278 AS "Score") AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, -0.182124004 AS "Score" UNION ALL SELECT 2 AS nid, 0.149085179 AS "Score") AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, 0.296248347 AS "Score" UNION ALL SELECT 2 AS nid, -0.130245715 AS "Score") AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, -0.138867661 AS "Score" UNION ALL SELECT 2 AS nid, 0.164351091 AS "Score") AS "Values"), 
"DT_Output_7" AS 

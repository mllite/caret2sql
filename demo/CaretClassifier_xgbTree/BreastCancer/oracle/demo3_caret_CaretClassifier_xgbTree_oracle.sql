...
FROM (SELECT 3 AS nid, -0.768159211 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.327272743 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.436363667 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, 0.761904776 AS "Score" FROM DUAL) "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.592611194 AS "Score" FROM DUAL UNION ALL SELECT 3 AS nid, -0.590538204 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.252212733 AS "Score" FROM DUAL) "Values"), 
"DT_Output_1" AS 

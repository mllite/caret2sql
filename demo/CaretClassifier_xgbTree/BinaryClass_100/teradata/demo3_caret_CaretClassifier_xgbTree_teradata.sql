...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_67" < CAST(-0.0814508051 AS DOUBLE PRECISION)) THEN 1 ELSE 2 END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
dummy_cte AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 1 AS nid, CAST(0.0545454584 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte UNION ALL SELECT 2 AS nid, CAST(-0.0363636389 AS DOUBLE PRECISION) AS "Score" 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 0 AS nid, CAST(0.00866288226 AS DOUBLE PRECISION) AS "Score" 
FROM dummy_cte) AS "Values"), 
"DT_Output_1" AS 

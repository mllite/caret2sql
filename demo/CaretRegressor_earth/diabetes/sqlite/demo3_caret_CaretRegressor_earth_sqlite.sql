...
earth_model_cte AS 
(SELECT earth_input."KEY" AS "KEY", 540.9158596123267 * max(earth_input."Feature_2" - -0.0514740612388061, 0) + 857.881142617963 * max(earth_input."Feature_8" - -0.0611765950943345, 0) + 585.6663066748639 * max(earth_input."Feature_3" - 0.0149866136074833, 0) + -185.62767022292832 * earth_input."Feature_1" + 288.9614021070438 * max(earth_input."Feature_9" - 0.0113486232440377, 0) + -770.2410768775819 * max(earth_input."Feature_4" - -0.0758704141630723, 0) + 607.3354601229668 * max(earth_input."Feature_5" - -0.034507614375909, 0) + 92.34557859695556 AS "Estimator" 
FROM earth_input)

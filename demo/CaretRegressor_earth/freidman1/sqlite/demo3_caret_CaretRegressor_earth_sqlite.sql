...
earth_model_cte AS 
(SELECT earth_input."KEY" AS "KEY", -8.380629989376796 * max(0.8231632932589577 - earth_input."Feature_1", 0) + 9.793918514381321 * max(earth_input."Feature_3" - 0.3244478925604231, 0) + -10.51380138268884 * max(0.3244478925604231 - earth_input."Feature_3", 0) + -13.116395395966398 * max(0.4348457212258143 - earth_input."Feature_0", 0) + 8.96110156348265 * max(earth_input."Feature_2" - 0.4562899507390336, 0) + 11.840075442823172 * max(0.4562899507390336 - earth_input."Feature_2", 0) + 6.607671635461544 * max(earth_input."Feature_4" - 0.4093658905237512, 0) + 13.435555385443774 AS "Estimator" 
FROM earth_input)

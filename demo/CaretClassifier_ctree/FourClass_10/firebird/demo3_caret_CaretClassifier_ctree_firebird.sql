...
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.043478260869565195 AS "P_0", 0.0 AS "P_1", 0.13043478260869598 AS "P_2", 0.8260869565217388 AS "P_3", 3 AS "D", 0.8260869565217388 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.5 AS "P_0", 0.375 AS "P_1", 0.0 AS "P_2", 0.125 AS "P_3", 0 AS "D", 0.5 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.9166666666666667 AS "P_0", 0.08333333333333329 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 0 AS "D", 0.9166666666666667 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 0.07407407407407408 AS "P_0", 0.5925925925925929 AS "P_1", 0.25925925925925897 AS "P_2", 0.07407407407407408 AS "P_3", 1 AS "D", 0.5925925925925929 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output" AS 

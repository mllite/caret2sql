...
FROM (SELECT 2 AS nid, 0.808510638297872 AS "P_0", 0.191489361702128 AS "P_1", 0 AS "D", 0.808510638297872 AS "DP" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.285714285714286 AS "P_0", 0.714285714285714 AS "P_1", 1 AS "D", 0.714285714285714 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output" AS 

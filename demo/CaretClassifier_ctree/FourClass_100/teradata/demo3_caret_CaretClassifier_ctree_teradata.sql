...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_44" <= CAST(-2.154589109912 AS DOUBLE PRECISION)) THEN 2 ELSE CASE WHEN ("ADS"."Feature_78" <= CAST(-0.715454553195 AS DOUBLE PRECISION)) THEN 4 ELSE 5 END END AS node_id_2 
...
FROM (SELECT 2 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_0", CAST(0.133333333333333 AS DOUBLE PRECISION) AS "P_1", CAST(0.866666666666667 AS DOUBLE PRECISION) AS "P_2", CAST(0.0 AS DOUBLE PRECISION) AS "P_3", 2 AS "D", CAST(0.866666666666667 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte UNION ALL SELECT 4 AS nid, CAST(0.058823529411765 AS DOUBLE PRECISION) AS "P_0", CAST(0.235294117647059 AS DOUBLE PRECISION) AS "P_1", CAST(0.264705882352941 AS DOUBLE PRECISION) AS "P_2", CAST(0.441176470588235 AS DOUBLE PRECISION) AS "P_3", 3 AS "D", CAST(0.441176470588235 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte UNION ALL SELECT 5 AS nid, CAST(0.468085106382979 AS DOUBLE PRECISION) AS "P_0", CAST(0.319148936170213 AS DOUBLE PRECISION) AS "P_1", CAST(0.021276595744681 AS DOUBLE PRECISION) AS "P_2", CAST(0.191489361702128 AS DOUBLE PRECISION) AS "P_3", 0 AS "D", CAST(0.468085106382979 AS DOUBLE PRECISION) AS "DP" 

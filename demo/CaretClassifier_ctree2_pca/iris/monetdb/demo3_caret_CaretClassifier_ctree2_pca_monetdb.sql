...
FROM (SELECT 4 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 2 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 0.5 AS "P_1", 0.5 AS "P_2", 1 AS "D", 0.5 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 0.857142857142857 AS "P_1", 0.142857142857143 AS "P_2", 1 AS "D", 0.857142857142857 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 9 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output" AS 

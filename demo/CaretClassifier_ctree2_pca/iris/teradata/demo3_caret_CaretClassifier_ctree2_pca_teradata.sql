...
FROM dummy_cte UNION ALL SELECT 5 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_0", CAST(0.5 AS DOUBLE PRECISION) AS "P_1", CAST(0.5 AS DOUBLE PRECISION) AS "P_2", 1 AS "D", CAST(0.5 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte UNION ALL SELECT 7 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_0", CAST(0.857142857142857 AS DOUBLE PRECISION) AS "P_1", CAST(0.142857142857143 AS DOUBLE PRECISION) AS "P_2", 1 AS "D", CAST(0.857142857142857 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte UNION ALL SELECT 8 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_0", CAST(1.0 AS DOUBLE PRECISION) AS "P_1", CAST(0.0 AS DOUBLE PRECISION) AS "P_2", 1 AS "D", CAST(1.0 AS DOUBLE PRECISION) AS "DP" 

...
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -0.1409300129025394 * linear_input."Feature_0" + 0.2374057696554108 * linear_input."Feature_1" + -0.1146737018440189 * linear_input."Feature_2" + -0.2383310882590158 * linear_input."Feature_3" + 0.6571649267148013 AS "Score_CLASS_0", 0.0 * linear_input."Feature_0" + -0.1870749837727063 * linear_input."Feature_1" + 0.0 * linear_input."Feature_2" + 0.0 * linear_input."Feature_3" + 0.5735517864487583 AS "Score_CLASS_1", 0.11528720243858685 * linear_input."Feature_0" + 0.0 * linear_input."Feature_1" + 0.07784824860723763 * linear_input."Feature_2" + 0.21302067714664585 * linear_input."Feature_3" + -1.2307167131635597 AS "Score_CLASS_2" 
FROM linear_input), 

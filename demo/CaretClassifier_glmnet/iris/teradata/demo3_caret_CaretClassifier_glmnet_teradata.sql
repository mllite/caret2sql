...
FROM iris AS "ADS"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", CAST(-0.140930012902539 AS DOUBLE PRECISION) * linear_input."Feature_0" + CAST(0.237405769655411 AS DOUBLE PRECISION) * linear_input."Feature_1" + CAST(-0.114673701844019 AS DOUBLE PRECISION) * linear_input."Feature_2" + CAST(-0.238331088259016 AS DOUBLE PRECISION) * linear_input."Feature_3" + CAST(0.657164926714801 AS DOUBLE PRECISION) AS "Score_0", CAST(0.0 AS DOUBLE PRECISION) * linear_input."Feature_0" + CAST(-0.187074983772706 AS DOUBLE PRECISION) * linear_input."Feature_1" + CAST(0.0 AS DOUBLE PRECISION) * linear_input."Feature_2" + CAST(0.0 AS DOUBLE PRECISION) * linear_input."Feature_3" + CAST(0.573551786448758 AS DOUBLE PRECISION) AS "Score_1", CAST(0.115287202438587 AS DOUBLE PRECISION) * linear_input."Feature_0" + CAST(0.0 AS DOUBLE PRECISION) * linear_input."Feature_1" + CAST(0.077848248607238 AS DOUBLE PRECISION) * linear_input."Feature_2" + CAST(0.213020677146646 AS DOUBLE PRECISION) * linear_input."Feature_3" + CAST(-1.23071671316356 AS DOUBLE PRECISION) AS "Score_2" 
FROM linear_input), 

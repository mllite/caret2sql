...
FROM iris AS "ADS"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 0.0 * linear_input."Feature_0" + 4.968028776468938 * linear_input."Feature_1" + -2.739488054445605 * linear_input."Feature_2" + -1.116679508426155 * linear_input."Feature_3" + 17.484445392504377 AS "Score_0", 3.4909406927712565 * linear_input."Feature_0" + 0.0 * linear_input."Feature_1" + 0.0 * linear_input."Feature_2" + 0.0 * linear_input."Feature_3" + 5.875256869057871 AS "Score_1", 0.0 * linear_input."Feature_0" + -4.163236120684314 * linear_input."Feature_1" + 9.468391677167467 * linear_input."Feature_2" + 9.90917542127401 * linear_input."Feature_3" + -23.359702261562248 AS "Score_2" 
FROM linear_input), 

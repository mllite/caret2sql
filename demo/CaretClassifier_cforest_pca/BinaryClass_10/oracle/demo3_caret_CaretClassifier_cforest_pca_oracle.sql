...
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 6 AS nid, 0.625 AS "P_0", 0.375 AS "P_1", 0 AS "D", 0.625 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 0.09090909090909091 AS "P_0", 0.9090909090909091 AS "P_1", 1 AS "D", 0.9090909090909091 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL) "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 5 AS nid, 0.153846153846154 AS "P_0", 0.846153846153846 AS "P_1", 1 AS "D", 0.846153846153846 AS "DP" FROM DUAL UNION ALL SELECT 6 AS nid, 0.75 AS "P_0", 0.25 AS "P_1", 0 AS "D", 0.75 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 0.470588235294118 AS "P_0", 0.529411764705882 AS "P_1", 1 AS "D", 0.529411764705882 AS "DP" FROM DUAL) "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 4 AS nid, 0.25 AS "P_0", 0.75 AS "P_1", 1 AS "D", 0.75 AS "DP" FROM DUAL UNION ALL SELECT 6 AS nid, 0.666666666666667 AS "P_0", 0.333333333333333 AS "P_1", 0 AS "D", 0.666666666666667 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 0.625 AS "P_0", 0.375 AS "P_1", 0 AS "D", 0.625 AS "DP" FROM DUAL) "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 4 AS nid, 0.285714285714286 AS "P_0", 0.714285714285714 AS "P_1", 1 AS "D", 0.714285714285714 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 0.857142857142857 AS "P_0", 0.142857142857143 AS "P_1", 0 AS "D", 0.857142857142857 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 0.5 AS "P_0", 0.5 AS "P_1", 0 AS "D", 0.5 AS "DP" FROM DUAL) "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 4 AS nid, 0.2 AS "P_0", 0.8 AS "P_1", 1 AS "D", 0.8 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 0.875 AS "P_0", 0.125 AS "P_1", 0 AS "D", 0.875 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 0.125 AS "P_0", 0.875 AS "P_1", 1 AS "D", 0.875 AS "DP" FROM DUAL) "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 4 AS nid, 0.375 AS "P_0", 0.625 AS "P_1", 1 AS "D", 0.625 AS "DP" FROM DUAL UNION ALL SELECT 6 AS nid, 0.142857142857143 AS "P_0", 0.857142857142857 AS "P_1", 1 AS "D", 0.857142857142857 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 0.96875 AS "P_0", 0.03125 AS "P_1", 0 AS "D", 0.96875 AS "DP" FROM DUAL) "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, 0.142857142857143 AS "P_0", 0.857142857142857 AS "P_1", 1 AS "D", 0.857142857142857 AS "DP" FROM DUAL UNION ALL SELECT 4 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 6 AS nid, 0.692307692307692 AS "P_0", 0.307692307692308 AS "P_1", 0 AS "D", 0.692307692307692 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 0.888888888888889 AS "P_0", 0.111111111111111 AS "P_1", 0 AS "D", 0.888888888888889 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL) "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, 0.142857142857143 AS "P_0", 0.857142857142857 AS "P_1", 1 AS "D", 0.857142857142857 AS "DP" FROM DUAL UNION ALL SELECT 4 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 0.857142857142857 AS "P_0", 0.142857142857143 AS "P_1", 0 AS "D", 0.857142857142857 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 0.315789473684211 AS "P_0", 0.684210526315789 AS "P_1", 1 AS "D", 0.684210526315789 AS "DP" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 5 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 6 AS nid, 0.857142857142857 AS "P_0", 0.142857142857143 AS "P_1", 0 AS "D", 0.857142857142857 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 0.470588235294118 AS "P_0", 0.529411764705882 AS "P_1", 1 AS "D", 0.529411764705882 AS "DP" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 4 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 5 AS nid, 0.357142857142857 AS "P_0", 0.642857142857143 AS "P_1", 1 AS "D", 0.642857142857143 AS "DP" FROM DUAL) "Values"), 
"DT_Output_9" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, 0.545454545454545 AS "P_0", 0.454545454545455 AS "P_1", 0 AS "D", 0.545454545454545 AS "DP" FROM DUAL UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 6 AS nid, 0.142857142857143 AS "P_0", 0.857142857142857 AS "P_1", 1 AS "D", 0.857142857142857 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 0.714285714285714 AS "P_0", 0.285714285714286 AS "P_1", 0 AS "D", 0.714285714285714 AS "DP" FROM DUAL) "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 5 AS nid, 0.875 AS "P_0", 0.125 AS "P_1", 0 AS "D", 0.875 AS "DP" FROM DUAL UNION ALL SELECT 6 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 10 AS nid, 0.3 AS "P_0", 0.7 AS "P_1", 1 AS "D", 0.7 AS "DP" FROM DUAL UNION ALL SELECT 11 AS nid, 0.714285714285714 AS "P_0", 0.285714285714286 AS "P_1", 0 AS "D", 0.714285714285714 AS "DP" FROM DUAL) "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 5 AS nid, 0.125 AS "P_0", 0.875 AS "P_1", 1 AS "D", 0.875 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 0.9166666666666667 AS "P_0", 0.08333333333333329 AS "P_1", 0 AS "D", 0.9166666666666667 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 0.666666666666667 AS "P_0", 0.333333333333333 AS "P_1", 0 AS "D", 0.666666666666667 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL) "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 5 AS nid, 0.625 AS "P_0", 0.375 AS "P_1", 0 AS "D", 0.625 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 0.714285714285714 AS "P_0", 0.285714285714286 AS "P_1", 0 AS "D", 0.714285714285714 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 10 AS nid, 0.07692307692307691 AS "P_0", 0.9230769230769231 AS "P_1", 1 AS "D", 0.9230769230769231 AS "DP" FROM DUAL UNION ALL SELECT 11 AS nid, 0.7 AS "P_0", 0.3 AS "P_1", 0 AS "D", 0.7 AS "DP" FROM DUAL) "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 4 AS nid, 0.333333333333333 AS "P_0", 0.666666666666667 AS "P_1", 1 AS "D", 0.666666666666667 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 0.857142857142857 AS "P_0", 0.142857142857143 AS "P_1", 0 AS "D", 0.857142857142857 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 0.2 AS "P_0", 0.8 AS "P_1", 1 AS "D", 0.8 AS "DP" FROM DUAL) "Values"), 
"DT_Output_14" AS 

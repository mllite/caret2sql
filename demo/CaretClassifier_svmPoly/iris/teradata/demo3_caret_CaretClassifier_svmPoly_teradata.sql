...
FROM (SELECT kernel_input_with_scaling."KEY" AS "KEY", "SV_data_0".dual_coeff * power(CAST(0.1 AS DOUBLE PRECISION) * (kernel_input_with_scaling."Feature_0" * "SV_data_0".sv_0 + kernel_input_with_scaling."Feature_1" * "SV_data_0".sv_1 + kernel_input_with_scaling."Feature_2" * "SV_data_0".sv_2 + kernel_input_with_scaling."Feature_3" * "SV_data_0".sv_3) + CAST(1.0 AS DOUBLE PRECISION), 3.0) AS dot_prod1 
...
FROM (SELECT kernel_input_with_scaling."KEY" AS "KEY", "SV_data_1".dual_coeff * power(CAST(0.1 AS DOUBLE PRECISION) * (kernel_input_with_scaling."Feature_0" * "SV_data_1".sv_0 + kernel_input_with_scaling."Feature_1" * "SV_data_1".sv_1 + kernel_input_with_scaling."Feature_2" * "SV_data_1".sv_2 + kernel_input_with_scaling."Feature_3" * "SV_data_1".sv_3) + CAST(1.0 AS DOUBLE PRECISION), 3.0) AS dot_prod1 
...
FROM (SELECT kernel_input_with_scaling."KEY" AS "KEY", "SV_data_2".dual_coeff * power(CAST(0.1 AS DOUBLE PRECISION) * (kernel_input_with_scaling."Feature_0" * "SV_data_2".sv_0 + kernel_input_with_scaling."Feature_1" * "SV_data_2".sv_1 + kernel_input_with_scaling."Feature_2" * "SV_data_2".sv_2 + kernel_input_with_scaling."Feature_3" * "SV_data_2".sv_3) + CAST(1.0 AS DOUBLE PRECISION), 3.0) AS dot_prod1 

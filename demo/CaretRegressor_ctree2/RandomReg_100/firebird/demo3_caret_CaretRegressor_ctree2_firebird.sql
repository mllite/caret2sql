...
FROM (SELECT 3 AS nid, -272.602938437202 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -16.4713467008337 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 100.561515442323 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output" AS 

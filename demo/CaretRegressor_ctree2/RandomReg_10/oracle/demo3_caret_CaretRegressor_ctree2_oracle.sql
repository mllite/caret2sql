...
FROM (SELECT 3 AS nid, -239.512915817104 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, -87.1983637153615 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 148.864700624648 AS "E" FROM DUAL UNION ALL SELECT 8 AS nid, -23.0119565200856 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 106.753935398927 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 271.084485119348 AS "E" FROM DUAL) "Values"), 
"DT_Output" AS 

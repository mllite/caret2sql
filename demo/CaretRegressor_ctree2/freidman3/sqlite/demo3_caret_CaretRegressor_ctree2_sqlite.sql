...
FROM (SELECT 2 AS nid, 0.863548222894211 AS "E" UNION ALL SELECT 5 AS nid, 1.52887679091562 AS "E" UNION ALL SELECT 7 AS nid, 1.34597099595076 AS "E" UNION ALL SELECT 8 AS nid, 1.4824295838166397 AS "E" UNION ALL SELECT 10 AS nid, 1.16429231772357 AS "E" UNION ALL SELECT 11 AS nid, 1.42567425020628 AS "E") AS "Values"), 
"DT_Output" AS 

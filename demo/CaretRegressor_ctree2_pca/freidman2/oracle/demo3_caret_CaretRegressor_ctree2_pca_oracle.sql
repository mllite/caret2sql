...
FROM (SELECT 3 AS nid, 107.41065284636 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 279.189348802644 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 627.680285357607 AS "E" FROM DUAL UNION ALL SELECT 8 AS nid, 797.03577675578 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 1100.66478470431 AS "E" FROM DUAL) "Values"), 
"DT_Output" AS 

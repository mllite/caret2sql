...
FROM (SELECT full_join_data_sv.[KEY] AS [KEY], sum(CAST(full_join_data_sv.dot_prod1 AS FLOAT(53))) + 0.0611938576447689 AS dot_product 
FROM (SELECT kernel_input_with_scaling.[KEY] AS [KEY], [SV_data].dual_coeff * power(CAST(0.1 * (kernel_input_with_scaling.[Feature_0] * [SV_data].sv_0 + kernel_input_with_scaling.[Feature_1] * [SV_data].sv_1 + kernel_input_with_scaling.[Feature_2] * [SV_data].sv_2 + kernel_input_with_scaling.[Feature_3] * [SV_data].sv_3) + 1.0 AS FLOAT(53)), 3.0) AS dot_prod1 

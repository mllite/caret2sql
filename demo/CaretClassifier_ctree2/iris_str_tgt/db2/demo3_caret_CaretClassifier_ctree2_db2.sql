...
FROM (SELECT 2 AS nid, 1.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_0' AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.0 AS "P_CLASS_0", 0.972972972972973 AS "P_CLASS_1", 0.027027027027027 AS "P_CLASS_2", 'CLASS_1' AS "D", 0.972972972972973 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.0 AS "P_CLASS_0", 0.428571428571429 AS "P_CLASS_1", 0.571428571428571 AS "P_CLASS_2", 'CLASS_2' AS "D", 0.571428571428571 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.0 AS "P_CLASS_0", 0.02564102564102561 AS "P_CLASS_1", 0.9743589743589745 AS "P_CLASS_2", 'CLASS_2' AS "D", 0.9743589743589745 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 

...
FROM (SELECT 2 AS nid, 0.833333333333333 AS "P_0", 0.166666666666667 AS "P_1", 0 AS "D", 0.833333333333333 AS "DP" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.0625 AS "P_0", 0.9375 AS "P_1", 1 AS "D", 0.9375 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output" AS 

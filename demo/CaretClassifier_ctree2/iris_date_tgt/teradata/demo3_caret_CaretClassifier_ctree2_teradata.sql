...
FROM dummy_cte UNION ALL SELECT 5 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_1789-07-14T00:00:00.000000000", CAST(0.972972972972973 AS DOUBLE PRECISION) AS "P_1789-08-14T00:00:00.000000000", CAST(0.027027027027027 AS DOUBLE PRECISION) AS "P_1789-09-14T00:00:00.000000000", '1789-08-14T00:00:00.000000000' AS "D", CAST(0.972972972972973 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte UNION ALL SELECT 6 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_1789-07-14T00:00:00.000000000", CAST(0.428571428571429 AS DOUBLE PRECISION) AS "P_1789-08-14T00:00:00.000000000", CAST(0.571428571428571 AS DOUBLE PRECISION) AS "P_1789-09-14T00:00:00.000000000", '1789-09-14T00:00:00.000000000' AS "D", CAST(0.571428571428571 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte UNION ALL SELECT 7 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_1789-07-14T00:00:00.000000000", CAST(0.025641025641026 AS DOUBLE PRECISION) AS "P_1789-08-14T00:00:00.000000000", CAST(0.974358974358974 AS DOUBLE PRECISION) AS "P_1789-09-14T00:00:00.000000000", '1789-09-14T00:00:00.000000000' AS "D", CAST(0.974358974358974 AS DOUBLE PRECISION) AS "DP" 

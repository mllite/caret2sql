...
FROM (SELECT 5 AS nid, 0.003787878787878791 AS "P_0", 0.9962121212121212 AS "P_1", 1 AS "D", 0.9962121212121212 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.148148148148148 AS "P_0", 0.851851851851852 AS "P_1", 1 AS "D", 0.851851851851852 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.75 AS "P_0", 0.25 AS "P_1", 0 AS "D", 0.75 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.9 AS "P_0", 0.1 AS "P_1", 0 AS "D", 0.9 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.985611510791367 AS "P_0", 0.0143884892086331 AS "P_1", 0 AS "D", 0.985611510791367 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.428571428571429 AS "P_0", 0.571428571428571 AS "P_1", 1 AS "D", 0.571428571428571 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 

...
FROM dummy_cte UNION ALL SELECT 5 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_0", CAST(0.972972972972973 AS DOUBLE PRECISION) AS "P_1", CAST(0.027027027027027 AS DOUBLE PRECISION) AS "P_2", 1 AS "D", CAST(0.972972972972973 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte UNION ALL SELECT 6 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_0", CAST(0.428571428571429 AS DOUBLE PRECISION) AS "P_1", CAST(0.571428571428571 AS DOUBLE PRECISION) AS "P_2", 2 AS "D", CAST(0.571428571428571 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte UNION ALL SELECT 7 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_0", CAST(0.025641025641026 AS DOUBLE PRECISION) AS "P_1", CAST(0.974358974358974 AS DOUBLE PRECISION) AS "P_2", 2 AS "D", CAST(0.974358974358974 AS DOUBLE PRECISION) AS "DP" 

...
FROM dummy_cte UNION ALL SELECT 6 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_CLASS_0", CAST(0.96969696969697 AS DOUBLE PRECISION) AS "P_CLASS_1", CAST(0.03030303030303 AS DOUBLE PRECISION) AS "P_CLASS_2", 'CLASS_1' AS "D", CAST(0.96969696969697 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte UNION ALL SELECT 7 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_CLASS_0", CAST(0.16 AS DOUBLE PRECISION) AS "P_CLASS_1", CAST(0.84 AS DOUBLE PRECISION) AS "P_CLASS_2", 'CLASS_2' AS "D", CAST(0.84 AS DOUBLE PRECISION) AS "DP" 

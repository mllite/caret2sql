...
FROM (SELECT 2 AS nid, 1.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_0' AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0 AS "P_CLASS_0", 0.9696969696969697 AS "P_CLASS_1", 0.030303030303030304 AS "P_CLASS_2", 'CLASS_1' AS "D", 0.9696969696969697 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0 AS "P_CLASS_0", 0.16 AS "P_CLASS_1", 0.84 AS "P_CLASS_2", 'CLASS_2' AS "D", 0.84 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output" AS 

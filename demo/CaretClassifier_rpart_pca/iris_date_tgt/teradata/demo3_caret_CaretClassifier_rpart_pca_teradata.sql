...
FROM dummy_cte UNION ALL SELECT 6 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_1789-07-14T00:00:00.000000000", CAST(0.96969696969697 AS DOUBLE PRECISION) AS "P_1789-08-14T00:00:00.000000000", CAST(0.03030303030303 AS DOUBLE PRECISION) AS "P_1789-09-14T00:00:00.000000000", '1789-08-14T00:00:00.000000000' AS "D", CAST(0.96969696969697 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte UNION ALL SELECT 7 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_1789-07-14T00:00:00.000000000", CAST(0.16 AS DOUBLE PRECISION) AS "P_1789-08-14T00:00:00.000000000", CAST(0.84 AS DOUBLE PRECISION) AS "P_1789-09-14T00:00:00.000000000", '1789-09-14T00:00:00.000000000' AS "D", CAST(0.84 AS DOUBLE PRECISION) AS "DP" 

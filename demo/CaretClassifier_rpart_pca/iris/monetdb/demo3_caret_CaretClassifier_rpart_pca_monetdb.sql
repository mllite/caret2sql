...
FROM (SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 0.9696969696969697 AS "P_1", 0.030303030303030304 AS "P_2", 1 AS "D", 0.9696969696969697 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 0.16 AS "P_1", 0.84 AS "P_2", 2 AS "D", 0.84 AS "DP") AS "Values"), 
"DT_Output" AS 

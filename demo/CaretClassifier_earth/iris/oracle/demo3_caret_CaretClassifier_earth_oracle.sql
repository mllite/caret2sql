...
FROM "IRIS" "ADS"), 
earth_model_cte AS 
(SELECT earth_input."KEY" AS "KEY", 41.41051746815792 * greatest(3.9 - earth_input."Feature_2", 0) + 1.0916742696901622 * greatest(earth_input."Feature_3" - 2.0, 0) + -0.6470962481520242 * greatest(earth_input."Feature_3" - 1.4, 0) + -0.6289207803667948 * greatest(earth_input."Feature_0" - 6.1, 0) + 4.62752589834204 * greatest(earth_input."Feature_2" - 5.1, 0) + -28.803998540862246 * greatest(earth_input."Feature_2" - 4.7, 0) + 24.996461690247845 * greatest(earth_input."Feature_2" - 3.3, 0) + -59.95228367656241 AS "Score_0", -6.395207315469439 * greatest(3.9 - earth_input."Feature_2", 0) + -56.88781758741218 * greatest(earth_input."Feature_3" - 2.0, 0) + -11.33063537642153 * greatest(earth_input."Feature_3" - 1.4, 0) + 12.361305279700884 * greatest(earth_input."Feature_0" - 6.1, 0) + -105.45956843275327 * greatest(earth_input."Feature_2" - 5.1, 0) + -16.63921624937212 * greatest(earth_input."Feature_2" - 4.7, 0) + -2.6226964767417966 * greatest(earth_input."Feature_2" - 3.3, 0) + 8.10905581702345 AS "Score_1", -144.96926576249902 * greatest(3.9 - earth_input."Feature_2", 0) + 56.55496348523766 * greatest(earth_input."Feature_3" - 2.0, 0) + 14.161242582484396 * greatest(earth_input."Feature_3" - 1.4, 0) + -13.014628435253607 * greatest(earth_input."Feature_0" - 6.1, 0) + 105.38632644998407 * greatest(earth_input."Feature_2" - 5.1, 0) + 27.112019529507016 * greatest(earth_input."Feature_2" - 4.7, 0) + -3.1134722516891964 * greatest(earth_input."Feature_2" - 3.3, 0) + -1.894913056077661 AS "Score_2" 
FROM earth_input), 

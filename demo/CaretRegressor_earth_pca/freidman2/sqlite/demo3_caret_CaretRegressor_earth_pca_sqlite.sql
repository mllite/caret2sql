...
FROM "ADS_pre_1_OUT"), 
earth_model_cte AS 
(SELECT earth_input."KEY" AS "KEY", 500.0748877078677 * max(earth_input."PC3" - -0.1469372564657002, 0) + -178.1475012977798 * max(-0.1469372564657002 - earth_input."PC3", 0) + -137.768251326947 * max(0.6258005673894007 - earth_input."PC1", 0) + -14.26690128500144 * max(earth_input."PC2" - -1.4144791366792062, 0) + -212.69753757544075 * max(-1.4144791366792062 - earth_input."PC2", 0) + -166.4218919822176 * max(earth_input."PC4" - 1.011503153093654, 0) + -25.694433757558738 * max(1.011503153093654 - earth_input."PC4", 0) + -148.26443030745295 * max(earth_input."PC1" - -1.3929600097741792, 0) + 711.545868761073 AS "Estimator" 
FROM earth_input)

...
FROM "ADS_sca_1_OUT"), 
centered_data AS 
(SELECT "ADS_pre_1_OUT"."KEY" AS "KEY", CAST("ADS_pre_1_OUT"."PC1" AS BINARY_DOUBLE) - 2.3248253354039 AS "PC1_0", CAST("ADS_pre_1_OUT"."PC2" AS BINARY_DOUBLE) - 0.33656870019053997 AS "PC2_0", CAST("ADS_pre_1_OUT"."PC3" AS BINARY_DOUBLE) - 0.0386061239886329 AS "PC3_0", CAST("ADS_pre_1_OUT"."PC4" AS BINARY_DOUBLE) - -0.0222431905330824 AS "PC4_0", CAST("ADS_pre_1_OUT"."PC1" AS BINARY_DOUBLE) - -0.39722822629121507 AS "PC1_1", CAST("ADS_pre_1_OUT"."PC2" AS BINARY_DOUBLE) - -0.554488583159194 AS "PC2_1", CAST("ADS_pre_1_OUT"."PC3" AS BINARY_DOUBLE) - 0.107227144244441 AS "PC3_1", CAST("ADS_pre_1_OUT"."PC4" AS BINARY_DOUBLE) - 0.028015344423174996 AS "PC4_1", CAST("ADS_pre_1_OUT"."PC1" AS BINARY_DOUBLE) - -1.63091647344874 AS "PC1_2", CAST("ADS_pre_1_OUT"."PC2" AS BINARY_DOUBLE) - 0.226197707425994 AS "PC2_2", CAST("ADS_pre_1_OUT"."PC3" AS BINARY_DOUBLE) - -0.132965403659466 AS "PC3_2", CAST("ADS_pre_1_OUT"."PC4" AS BINARY_DOUBLE) - -0.00692129598146406 AS "PC4_2" 
FROM "ADS_pre_1_OUT"), 
"NaiveBayes_data" AS 

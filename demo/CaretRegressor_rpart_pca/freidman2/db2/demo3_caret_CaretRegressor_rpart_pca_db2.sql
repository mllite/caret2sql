...
FROM "ADS_sca_1_OUT"), 
"DT_node_lookup" AS 
(SELECT "ADS_pre_1_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_pre_1_OUT"."PC3" < 0.20820323843847646) THEN 2 ELSE CASE WHEN ("ADS_pre_1_OUT"."PC3" < 1.0464320157523244) THEN 6 ELSE 7 END END AS node_id_2 
FROM "ADS_pre_1_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 2 AS nid, 214.2951747747145 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 708.3257574519748 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1100.6647847043066 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 

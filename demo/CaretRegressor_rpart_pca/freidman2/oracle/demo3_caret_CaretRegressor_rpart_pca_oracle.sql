...
FROM (SELECT 2 AS nid, 214.2951747747145 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 708.3257574519748 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 1100.6647847043066 AS "E" FROM DUAL) "Values"), 
"DT_Output" AS 

...
FROM (SELECT 3 AS nid, 1.473565120352516 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 1.001159815852261 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, 1.3541172191495907 AS "E" FROM DUAL) "Values"), 
"DT_Output" AS 

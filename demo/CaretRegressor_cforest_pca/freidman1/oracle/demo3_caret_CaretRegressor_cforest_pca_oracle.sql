...
FROM (SELECT 3 AS nid, 19.504720790708102 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 22.662780816279 AS "E" FROM DUAL UNION ALL SELECT 8 AS nid, 15.412236300288699 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 12.073968114960499 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 16.4270219926218 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 9.79868046768724 AS "E" FROM DUAL) "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 3 AS nid, 18.7665559466849 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 22.3107617983661 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 12.9949502369678 AS "E" FROM DUAL UNION ALL SELECT 8 AS nid, 8.350043480346411 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 16.9776413915331 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 12.8135541742246 AS "E" FROM DUAL) "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 3 AS nid, 16.9751045507357 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 21.0217153483056 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 10.2942572378851 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 15.9033607767934 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 18.2243835476427 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 13.925954259453 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 9.47023330583278 AS "E" FROM DUAL) "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 3 AS nid, 21.0707181031551 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, 14.1427301110429 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 18.8773536422818 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 9.88833958237558 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 14.7511046253413 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 7.56680040998904 AS "E" FROM DUAL) "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 4 AS nid, 21.653103437115696 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, 18.727123906704897 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 14.4020250010883 AS "E" FROM DUAL UNION ALL SELECT 8 AS nid, 19.5214883325197 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 13.3812632574864 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 10.385228037262 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 7.551433533069849 AS "E" FROM DUAL) "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 3 AS nid, 20.434523385964198 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, 14.3971639504971 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 18.0595256352343 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 10.5502770267107 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 16.0929187403779 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 10.49831516758 AS "E" FROM DUAL) "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 3 AS nid, 18.1849695955122 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 21.344672325119397 AS "E" FROM DUAL UNION ALL SELECT 8 AS nid, 9.614750886336278 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 7.930159058248741 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 14.734785514153302 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 17.3017663822536 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 14.196612618276598 AS "E" FROM DUAL) "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 3 AS nid, 21.4076138390031 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, 13.294788431126499 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 21.2622710741168 AS "E" FROM DUAL UNION ALL SELECT 8 AS nid, 16.6301075968004 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 12.0672234523811 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 16.934466035797698 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 10.167088598531699 AS "E" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 3 AS nid, 20.8583961378902 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, 18.5410530800638 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 15.1991762697583 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 13.887722210092699 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 9.86019846871143 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 15.9489837128847 AS "E" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 3 AS nid, 21.879178434931998 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, 18.156905049641303 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 20.156215259768697 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 13.758863852293198 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 18.283070395983 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 9.54103095178361 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 7.748333598045571 AS "E" FROM DUAL) "Values"), 
"DT_Output_9" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 4 AS nid, 19.7791163709934 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, 17.828498553027803 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 12.4414418716425 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 18.4460282732785 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 16.3299823154651 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 12.8050303436957 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 8.81692914993715 AS "E" FROM DUAL) "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 2 AS nid, 19.7972897049688 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 8.07922400589965 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 13.8403990739741 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 17.8161805719757 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 14.5758459777926 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 10.546612938467 AS "E" FROM DUAL) "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 3 AS nid, 17.281204709054197 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 21.5185154698042 AS "E" FROM DUAL UNION ALL SELECT 8 AS nid, 12.962922308022803 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 15.718515332291801 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 8.63368746994289 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 17.1130430622415 AS "E" FROM DUAL) "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 3 AS nid, 19.4307308075019 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 14.142894891568599 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 10.492495703145599 AS "E" FROM DUAL UNION ALL SELECT 8 AS nid, 7.72256504208856 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 20.2257173940391 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 16.6475984871026 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 13.6787968391034 AS "E" FROM DUAL) "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 3 AS nid, 21.5630235005675 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 16.4425861388876 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 20.1798224476645 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 14.4210266311695 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 16.8320968611952 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 10.2584571105934 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 13.2255225256127 AS "E" FROM DUAL UNION ALL SELECT 15 AS nid, 7.5349960677397 AS "E" FROM DUAL) "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
FROM (SELECT 3 AS nid, 23.3144997932343 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, 15.361905429710902 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 19.7677940487932 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 13.1586543448899 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 10.3306149160833 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 8.440805008554719 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 11.947467881382 AS "E" FROM DUAL UNION ALL SELECT 15 AS nid, 16.229248604597 AS "E" FROM DUAL) "Values"), 
"DT_Output_15" AS 

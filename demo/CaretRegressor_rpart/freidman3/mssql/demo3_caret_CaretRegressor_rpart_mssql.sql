...
FROM (SELECT 2 AS nid, 0.8635482228942107 AS [E] UNION ALL SELECT 6 AS nid, 1.3012066633097508 AS [E] UNION ALL SELECT 7 AS nid, 1.4885288588495236 AS [E]) AS [Values]), 
[DT_Output] AS 

...
FROM (SELECT 2 AS nid, 112.5593220338983 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 178.79411764705884 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 253.725 AS "E" FROM DUAL) "Values"), 
"DT_Output" AS 

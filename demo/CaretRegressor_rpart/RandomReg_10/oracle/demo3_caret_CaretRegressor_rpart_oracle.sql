...
FROM (SELECT 3 AS nid, 158.64050214470126 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -239.51291581710444 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, 5.984424839905532 AS "E" FROM DUAL) "Values"), 
"DT_Output" AS 

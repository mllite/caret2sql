...
FROM (SELECT 3 AS nid, 18.270077573225237 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 10.79389336190427 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, 16.62049825513814 AS "E" FROM DUAL) "Values"), 
"DT_Output" AS 

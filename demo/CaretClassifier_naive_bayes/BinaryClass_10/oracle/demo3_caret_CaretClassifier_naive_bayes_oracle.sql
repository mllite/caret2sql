...
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS BINARY_DOUBLE) - 0.873654099723867 AS "Feature_0_0", CAST("ADS"."Feature_1" AS BINARY_DOUBLE) - 0.224178233225322 AS "Feature_1_0", CAST("ADS"."Feature_2" AS BINARY_DOUBLE) - 0.0523804017328524 AS "Feature_2_0", CAST("ADS"."Feature_3" AS BINARY_DOUBLE) - 0.00819429211215264 AS "Feature_3_0", CAST("ADS"."Feature_4" AS BINARY_DOUBLE) - 0.0424485335140869 AS "Feature_4_0", CAST("ADS"."Feature_5" AS BINARY_DOUBLE) - -0.0117759292946001 AS "Feature_5_0", CAST("ADS"."Feature_6" AS BINARY_DOUBLE) - 0.385052285364005 AS "Feature_6_0", CAST("ADS"."Feature_7" AS BINARY_DOUBLE) - 0.346265469014169 AS "Feature_7_0", CAST("ADS"."Feature_8" AS BINARY_DOUBLE) - -0.114049479811569 AS "Feature_8_0", CAST("ADS"."Feature_9" AS BINARY_DOUBLE) - -0.8981761455859459 AS "Feature_9_0", CAST("ADS"."Feature_0" AS BINARY_DOUBLE) - -0.7499956892475981 AS "Feature_0_1", CAST("ADS"."Feature_1" AS BINARY_DOUBLE) - 0.129871042118345 AS "Feature_1_1", CAST("ADS"."Feature_2" AS BINARY_DOUBLE) - 0.0303872983652165 AS "Feature_2_1", CAST("ADS"."Feature_3" AS BINARY_DOUBLE) - 0.25301864400479 AS "Feature_3_1", CAST("ADS"."Feature_4" AS BINARY_DOUBLE) - -0.161564742953749 AS "Feature_4_1", CAST("ADS"."Feature_5" AS BINARY_DOUBLE) - -0.0860822504456115 AS "Feature_5_1", CAST("ADS"."Feature_6" AS BINARY_DOUBLE) - -0.00301632812974252 AS "Feature_6_1", CAST("ADS"."Feature_7" AS BINARY_DOUBLE) - -0.30216627554882003 AS "Feature_7_1", CAST("ADS"."Feature_8" AS BINARY_DOUBLE) - -0.00141014825671085 AS "Feature_8_1", CAST("ADS"."Feature_9" AS BINARY_DOUBLE) - 0.793076961481881 AS "Feature_9_1" 

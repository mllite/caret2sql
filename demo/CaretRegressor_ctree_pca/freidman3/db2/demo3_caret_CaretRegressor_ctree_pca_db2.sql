...
FROM (SELECT 2 AS nid, 1.1141061849074099 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.3643933364328402 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 1.48631528766843 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.5454993885883102 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.50843913328263 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 

...
FROM "ADS_pre_1_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 0.15986176876130936 * linear_input."PC1" + 0.0006068643811295388 * linear_input."PC2" + 0.0 * linear_input."PC3" + 0.0 * linear_input."PC4" + -0.08943677876939068 AS "Score_0", 0.0 * linear_input."PC1" + -0.08314166127433004 * linear_input."PC2" + 0.0 * linear_input."PC3" + 0.0 * linear_input."PC4" + 0.01869087227870819 AS "Score_1", -0.11306290162491192 * linear_input."PC1" + 0.0 * linear_input."PC2" + -0.06153452363958975 * linear_input."PC3" + 0.0 * linear_input."PC4" + 0.07074590649068249 AS "Score_2" 
FROM linear_input), 

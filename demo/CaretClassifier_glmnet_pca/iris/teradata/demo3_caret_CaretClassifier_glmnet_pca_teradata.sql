...
FROM "ADS_pre_1_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", CAST(0.159861768761309 AS DOUBLE PRECISION) * linear_input."PC1" + CAST(0.00060686438113 AS DOUBLE PRECISION) * linear_input."PC2" + CAST(0.0 AS DOUBLE PRECISION) * linear_input."PC3" + CAST(0.0 AS DOUBLE PRECISION) * linear_input."PC4" + CAST(-0.089436778769391 AS DOUBLE PRECISION) AS "Score_0", CAST(0.0 AS DOUBLE PRECISION) * linear_input."PC1" + CAST(-0.08314166127433 AS DOUBLE PRECISION) * linear_input."PC2" + CAST(0.0 AS DOUBLE PRECISION) * linear_input."PC3" + CAST(0.0 AS DOUBLE PRECISION) * linear_input."PC4" + CAST(0.018690872278708 AS DOUBLE PRECISION) AS "Score_1", CAST(-0.113062901624912 AS DOUBLE PRECISION) * linear_input."PC1" + CAST(0.0 AS DOUBLE PRECISION) * linear_input."PC2" + CAST(-0.06153452363959 AS DOUBLE PRECISION) * linear_input."PC3" + CAST(0.0 AS DOUBLE PRECISION) * linear_input."PC4" + CAST(0.070745906490682 AS DOUBLE PRECISION) AS "Score_2" 
FROM linear_input), 

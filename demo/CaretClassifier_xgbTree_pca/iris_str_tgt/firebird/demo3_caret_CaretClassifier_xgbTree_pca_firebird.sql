...
FROM (SELECT "XGB_Model_2_0"."KEY" AS "KEY", CAST("XGB_Model_2_0"."Score_CLASS_0" AS DOUBLE PRECISION) AS "Score_CLASS_0", CAST("XGB_Model_2_0"."Score_CLASS_1" AS DOUBLE PRECISION) AS "Score_CLASS_1", CAST("XGB_Model_2_0"."Score_CLASS_2" AS DOUBLE PRECISION) AS "Score_CLASS_2" 
...
FROM (SELECT "XGB_Model_1_1"."KEY" AS "KEY", CAST("XGB_Model_1_1"."Score_CLASS_0" AS DOUBLE PRECISION) AS "Score_CLASS_0", CAST("XGB_Model_1_1"."Score_CLASS_1" AS DOUBLE PRECISION) AS "Score_CLASS_1", CAST("XGB_Model_1_1"."Score_CLASS_2" AS DOUBLE PRECISION) AS "Score_CLASS_2" 
FROM "XGB_Model_1_1" UNION ALL SELECT "XGB_Model_2_1"."KEY" AS "KEY", CAST("XGB_Model_2_1"."Score_CLASS_0" AS DOUBLE PRECISION) AS "Score_CLASS_0", CAST("XGB_Model_2_1"."Score_CLASS_1" AS DOUBLE PRECISION) AS "Score_CLASS_1", CAST("XGB_Model_2_1"."Score_CLASS_2" AS DOUBLE PRECISION) AS "Score_CLASS_2" 

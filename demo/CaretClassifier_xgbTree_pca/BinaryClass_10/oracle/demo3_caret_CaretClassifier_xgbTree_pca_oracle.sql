...
FROM (SELECT 1 AS nid, -0.109090917 AS "Score" FROM DUAL UNION ALL SELECT 2 AS nid, 0.109090917 AS "Score" FROM DUAL) "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 0 AS nid, 0 AS "Score" FROM DUAL) "Values"), 
"DT_Output_1" AS 

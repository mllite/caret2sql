...
FROM (SELECT 1 AS nid, 0.204552919 AS "Estimator" UNION ALL SELECT 2 AS nid, 0.373086601 AS "Estimator") AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
FROM (SELECT 2 AS nid, 0.24979268 AS "Estimator" UNION ALL SELECT 3 AS nid, 0.125014514 AS "Estimator" UNION ALL SELECT 4 AS nid, 0.21346572 AS "Estimator") AS "Values"), 
"DT_Output_1" AS 

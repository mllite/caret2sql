...
FROM (SELECT 3 AS nid, 60.2083321 AS "Estimator" UNION ALL SELECT 4 AS nid, 86.302269 AS "Estimator" UNION ALL SELECT 5 AS nid, 42.8278694 AS "Estimator" UNION ALL SELECT 6 AS nid, 65.8041687 AS "Estimator") AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
FROM (SELECT 3 AS nid, 56.0983162 AS "Estimator" UNION ALL SELECT 4 AS nid, 26.6974316 AS "Estimator" UNION ALL SELECT 5 AS nid, 27.6771088 AS "Estimator" UNION ALL SELECT 6 AS nid, 46.6368332 AS "Estimator") AS "Values"), 
"DT_Output_1" AS 

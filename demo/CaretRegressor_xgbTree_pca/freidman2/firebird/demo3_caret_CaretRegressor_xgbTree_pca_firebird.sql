...
FROM (SELECT 3 AS nid, 43.3258896 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 104.796425 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 248.3302 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 404.895721 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
FROM (SELECT 1 AS nid, 71.2575607 AS "Estimator" FROM rdb$database UNION ALL SELECT 3 AS nid, 190.83403 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 113.611122 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 

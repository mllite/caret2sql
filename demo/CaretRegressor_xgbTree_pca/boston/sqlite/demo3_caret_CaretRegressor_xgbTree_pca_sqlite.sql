...
FROM (SELECT 3 AS nid, 8.96071434 AS "Estimator" UNION ALL SELECT 4 AS nid, 14.5580645 AS "Estimator" UNION ALL SELECT 5 AS nid, 7.34190464 AS "Estimator" UNION ALL SELECT 6 AS nid, 4.51692343 AS "Estimator") AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
FROM (SELECT 3 AS nid, 4.1841321 AS "Estimator" UNION ALL SELECT 4 AS nid, 2.28718829 AS "Estimator" UNION ALL SELECT 5 AS nid, 5.77468348 AS "Estimator" UNION ALL SELECT 6 AS nid, 2.68898296 AS "Estimator") AS "Values"), 
"DT_Output_1" AS 

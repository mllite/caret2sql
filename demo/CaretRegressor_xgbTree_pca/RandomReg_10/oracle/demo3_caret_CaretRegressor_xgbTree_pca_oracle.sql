...
FROM (SELECT 1 AS nid, -84.7875519 AS "Estimator" FROM DUAL UNION ALL SELECT 3 AS nid, -30.5873508 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, 60.2983093 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
FROM (SELECT 3 AS nid, -47.7487259 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, 29.7972469 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, -14.5889893 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 54.3916435 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_1" AS 

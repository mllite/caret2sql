...
FROM [DT_node_lookup] LEFT OUTER JOIN [DT_node_data] ON [DT_node_lookup].node_id_2 = [DT_node_data].nid)
 SELECT [DT_Output].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_0], CAST(NULL AS FLOAT(53)) AS [Score_1], CAST(NULL AS FLOAT(53)) AS [Score_2], CAST(NULL AS FLOAT(53)) AS [Score_3], CAST(NULL AS FLOAT(53)) AS [Score_4], CAST(NULL AS FLOAT(53)) AS [Score_5], CAST(NULL AS FLOAT(53)) AS [Score_6], CAST(NULL AS FLOAT(53)) AS [Score_7], CAST(NULL AS FLOAT(53)) AS [Score_8], CAST(NULL AS FLOAT(53)) AS [Score_9], [DT_Output].[P_0] AS [Proba_0], [DT_Output].[P_1] AS [Proba_1], [DT_Output].[P_2] AS [Proba_2], [DT_Output].[P_3] AS [Proba_3], [DT_Output].[P_4] AS [Proba_4], [DT_Output].[P_5] AS [Proba_5], [DT_Output].[P_6] AS [Proba_6], [DT_Output].[P_7] AS [Proba_7], [DT_Output].[P_8] AS [Proba_8], [DT_Output].[P_9] AS [Proba_9], CASE WHEN ([DT_Output].[P_0] IS NULL OR [DT_Output].[P_0] > 0.0) THEN log([DT_Output].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_0], CASE WHEN ([DT_Output].[P_1] IS NULL OR [DT_Output].[P_1] > 0.0) THEN log([DT_Output].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_1], CASE WHEN ([DT_Output].[P_2] IS NULL OR [DT_Output].[P_2] > 0.0) THEN log([DT_Output].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_2], CASE WHEN ([DT_Output].[P_3] IS NULL OR [DT_Output].[P_3] > 0.0) THEN log([DT_Output].[P_3]) ELSE -1.79769313486231e+308 END AS [LogProba_3], CASE WHEN ([DT_Output].[P_4] IS NULL OR [DT_Output].[P_4] > 0.0) THEN log([DT_Output].[P_4]) ELSE -1.79769313486231e+308 END AS [LogProba_4], CASE WHEN ([DT_Output].[P_5] IS NULL OR [DT_Output].[P_5] > 0.0) THEN log([DT_Output].[P_5]) ELSE -1.79769313486231e+308 END AS [LogProba_5], CASE WHEN ([DT_Output].[P_6] IS NULL OR [DT_Output].[P_6] > 0.0) THEN log([DT_Output].[P_6]) ELSE -1.79769313486231e+308 END AS [LogProba_6], CASE WHEN ([DT_Output].[P_7] IS NULL OR [DT_Output].[P_7] > 0.0) THEN log([DT_Output].[P_7]) ELSE -1.79769313486231e+308 END AS [LogProba_7], CASE WHEN ([DT_Output].[P_8] IS NULL OR [DT_Output].[P_8] > 0.0) THEN log([DT_Output].[P_8]) ELSE -1.79769313486231e+308 END AS [LogProba_8], CASE WHEN ([DT_Output].[P_9] IS NULL OR [DT_Output].[P_9] > 0.0) THEN log([DT_Output].[P_9]) ELSE -1.79769313486231e+308 END AS [LogProba_9], [DT_Output].[D] AS [Decision], [DT_Output].[DP] AS [DecisionProba] 
FROM [DT_Output]
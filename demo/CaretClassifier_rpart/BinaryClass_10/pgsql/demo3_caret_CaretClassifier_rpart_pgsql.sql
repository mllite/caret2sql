...
FROM (SELECT 2 AS nid, 0.8085106382978723 AS "P_0", 0.1914893617021277 AS "P_1", 0 AS "D", 0.8085106382978723 AS "DP" UNION ALL SELECT 3 AS nid, 0.06060606060606062 AS "P_0", 0.9393939393939393 AS "P_1", 1 AS "D", 0.9393939393939393 AS "DP") AS "Values"), 
"DT_Output" AS 

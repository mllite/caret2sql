...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" < 0.03440605737600827) THEN 2 ELSE 3 END AS node_id_2 
FROM "BINARYCLASS_10" AS "ADS"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.8085106382978723 AS "P_0", 0.1914893617021277 AS "P_1", 0 AS "D", 0.8085106382978723 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.06060606060606062 AS "P_0", 0.9393939393939393 AS "P_1", 1 AS "D", 0.9393939393939393 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 

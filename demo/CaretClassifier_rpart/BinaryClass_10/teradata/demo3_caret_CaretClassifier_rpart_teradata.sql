...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" < CAST(0.034406057376008 AS DOUBLE PRECISION)) THEN 2 ELSE 3 END AS node_id_2 
...
FROM dummy_cte UNION ALL SELECT 3 AS nid, CAST(0.060606060606061 AS DOUBLE PRECISION) AS "P_0", CAST(0.939393939393939 AS DOUBLE PRECISION) AS "P_1", 1 AS "D", CAST(0.939393939393939 AS DOUBLE PRECISION) AS "DP" 

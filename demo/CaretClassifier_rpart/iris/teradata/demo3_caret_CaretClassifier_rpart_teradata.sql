...
FROM dummy_cte UNION ALL SELECT 6 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_0", CAST(0.948717948717949 AS DOUBLE PRECISION) AS "P_1", CAST(0.051282051282051 AS DOUBLE PRECISION) AS "P_2", 1 AS "D", CAST(0.948717948717949 AS DOUBLE PRECISION) AS "DP" 
FROM dummy_cte UNION ALL SELECT 7 AS nid, CAST(0.0 AS DOUBLE PRECISION) AS "P_0", CAST(0.068181818181818 AS DOUBLE PRECISION) AS "P_1", CAST(0.931818181818182 AS DOUBLE PRECISION) AS "P_2", 2 AS "D", CAST(0.931818181818182 AS DOUBLE PRECISION) AS "DP" 

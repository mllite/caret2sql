...
FROM (SELECT 2 AS nid, 1.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_0' AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0 AS "P_CLASS_0", 0.9487179487179488 AS "P_CLASS_1", 0.05128205128205128 AS "P_CLASS_2", 'CLASS_1' AS "D", 0.9487179487179488 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0 AS "P_CLASS_0", 0.06818181818181819 AS "P_CLASS_1", 0.9318181818181818 AS "P_CLASS_2", 'CLASS_2' AS "D", 0.9318181818181818 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output" AS 

...
FROM (SELECT 2 AS nid, 0.8333333333333334 AS "P_0", 0.16666666666666669 AS "P_1", 0 AS "D", 0.8333333333333334 AS "DP" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.06250000000000001 AS "P_0", 0.9375 AS "P_1", 1 AS "D", 0.9375 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output" AS 

...
FROM (SELECT 3 AS nid, 0.0 AS "P_0", 0.13333333333333333 AS "P_1", 0.8666666666666667 AS "P_2", 0.0 AS "P_3", 2 AS "D", 0.8666666666666667 AS "DP" UNION ALL SELECT 4 AS nid, 0.4680851063829786 AS "P_0", 0.3191489361702128 AS "P_1", 0.02127659574468085 AS "P_2", 0.1914893617021277 AS "P_3", 0 AS "D", 0.4680851063829786 AS "DP" UNION ALL SELECT 5 AS nid, 0.0588235294117647 AS "P_0", 0.23529411764705885 AS "P_1", 0.2647058823529412 AS "P_2", 0.4411764705882353 AS "P_3", 3 AS "D", 0.4411764705882353 AS "DP") AS "Values"), 
"DT_Output" AS 

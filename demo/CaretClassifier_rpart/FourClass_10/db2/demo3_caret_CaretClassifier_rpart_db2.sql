...
FROM (SELECT 4 AS nid, 0.5517241379310345 AS "P_0", 0.0 AS "P_1", 0.20689655172413796 AS "P_2", 0.2413793103448276 AS "P_3", 0 AS "D", 0.5517241379310345 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.08 AS "P_0", 0.68 AS "P_1", 0.16 AS "P_2", 0.08 AS "P_3", 1 AS "D", 0.68 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 0.18750000000000006 AS "P_1", 0.0 AS "P_2", 0.8125 AS "P_3", 3 AS "D", 0.8125 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 

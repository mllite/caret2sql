...
FROM (SELECT full_join_data_sv.[KEY] AS [KEY], sum(CAST(full_join_data_sv.dot_prod1 AS FLOAT(53))) + 1.58630870429677 AS dot_product 
...
[OVR_Score_0] AS 
(SELECT kernel_dp_0.[KEY] AS [KEY_0], CAST(NULL AS FLOAT(53)) AS [Proba_0], kernel_dp_0.dot_product AS [Score_0] 
FROM kernel_dp_0), 
[SV_data_1] AS 
(SELECT [Values].sv_idx AS sv_idx, [Values].dual_coeff AS dual_coeff, [Values].sv_0 AS sv_0, [Values].sv_1 AS sv_1, [Values].sv_2 AS sv_2, [Values].sv_3 AS sv_3 
...
FROM (SELECT full_join_data_sv_1.[KEY] AS [KEY], sum(CAST(full_join_data_sv_1.dot_prod1 AS FLOAT(53))) + 0.359611754189863 AS dot_product 
...
[OVR_Score_1] AS 
(SELECT kernel_dp_1.[KEY] AS [KEY_1], CAST(NULL AS FLOAT(53)) AS [Proba_1], kernel_dp_1.dot_product AS [Score_1] 
FROM kernel_dp_1), 
[SV_data_2] AS 
(SELECT [Values].sv_idx AS sv_idx, [Values].dual_coeff AS dual_coeff, [Values].sv_0 AS sv_0, [Values].sv_1 AS sv_1, [Values].sv_2 AS sv_2, [Values].sv_3 AS sv_3 
...
FROM (SELECT full_join_data_sv_2.[KEY] AS [KEY], sum(CAST(full_join_data_sv_2.dot_prod1 AS FLOAT(53))) + -2.7093604181989 AS dot_product 
...
[OVR_Score_2] AS 
(SELECT kernel_dp_2.[KEY] AS [KEY_2], CAST(NULL AS FLOAT(53)) AS [Proba_2], kernel_dp_2.dot_product AS [Score_2] 
FROM kernel_dp_2), 
[OVR_Join_CTE] AS 
